...
namespace SlidingWindow
{
  ...
  std::vector<std::vector<double>> SlidingWindowExecuteBothAverage(const xAOD::JetContainer*  jetcont,const xAOD::IParticleContainer*  clustercont);
  std::vector<std::vector<double>> SlidingWindowExecuteBoth_Normalised(const xAOD::JetContainer*  jetcont,const xAOD::IParticleContainer*  clustercont, double rho_orig);
