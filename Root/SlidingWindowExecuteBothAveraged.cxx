...
#include "xAODAnaHelpers/fastjetmp.h"
std::vector<std::vector<double>> SlidingWindow::SlidingWindowExecuteBothAverage(const xAOD::JetContainer* jetcont, const xAOD::IParticleContainer* Iparcont){
...
//clear this vector if there's some junk in memory
 ...
 for (rho i){
   myReturnVectoraverage.push_back(avaerage(rho[i]))
